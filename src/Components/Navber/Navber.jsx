...
const Navber = () => {
    ...
    const navlinks = <>
        ...
        {
            user ? "" : <> <li> <NavLink className='no-underline' to='/login'>login</NavLink></li>
                <li> <NavLink className='no-underline' to='/register'>Register</NavLink></li></>
        }
    </>
    return (
        <div className="navbar flex items-center justify-between bg-base-100">
            <div className="">
                ...
                <div className="flex items-center">
                    <img src={iconjob} className='w-[30px]' alt="" />
